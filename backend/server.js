...
app.use(
    session({
        secret: "this is a very very long long long long secret", // Replace with a strong random value
        resave: false,
...
const corsOptions = {
    origin: ['https://amply-1.onrender.com','https://amply-liard.vercel.app', 'http://localhost:5173', 'http://localhost:5178'],
